...
public class BusquedaVueloFalabellaPage extends SeleniumBasePage {

    public BusquedaVueloFalabellaPage(WebDriver driver) {
        super(driver);
    }
    ...
    By localizadorDateEnd = By.xpath("//input[contains(@class, \"sbox-bind-reference-flight-end-date-input\" )]");
    ...
    By localizadorBtnComprar = By.xpath("(//em [@class=\"btn-text\"])[7]");
    ...
    public void localizarCasillaPasajeros (){click(localizadorPasajeros);}
    public void localizadorBTNAumentarAdultos(){click(localizadorAumentarAdultos);}
    public void localizadorBotonAplicarPasajeros(){click(localizadorBtnAplicarPasajeros);}
    public void localizadorBotonComprar(){click(localizadorBtnComprar);}
    public void localizarVolverAtras(){click(localizadorVolverAPaginaAnterior);}
